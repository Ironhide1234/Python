import json
from interface import ICourse, ILocalCourse, IOffsiteCourse, ITeacher, ICourseFactory
...
teacher = LocalTeacher("it", "Arseniy") 
print(teacher)

course = LocalCourse("it", teacher, ['math', 'eng'], 228)
print(course)
